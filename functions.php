...
include_once (ZS_DIR . 'custom-excerpt.php');//自定义文字长度
...
function subo_style()
{
    ...
    wp_register_style('subo_web',CSS_URL . 'style.css', array() , '20170206' );
...
function subo_scripts() {
	...
	wp_enqueue_script( 'subo-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
